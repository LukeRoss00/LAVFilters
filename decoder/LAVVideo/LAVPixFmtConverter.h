...
public:
  ...
  HRESULT ConvertOverUnder(const uint8_t * const srcBase[4], const uint8_t * const srcExtra[4], const ptrdiff_t srcStride[4], uint8_t *dst, int width, int height, ptrdiff_t dstStride, int planeHeight);
